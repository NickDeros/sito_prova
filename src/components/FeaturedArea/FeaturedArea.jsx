...
import Logo from "../../assets/images/resources/logo.jpg";
...
const FeaturedArea = () => {
  return (
    // xl:rounded-br-[20rem] lg:rounded-br-[18rem] md:rounded-br-[15rem] sm:rounded-br-[10rem] rounded-br-0
    <section className="featuredAreaWrap md:text-left text-center bg-dark z-[1] flex items-center bgGrident1 bg-blend-hard-light xl:rounded-br-[20rem] lg:rounded-br-[18rem] md:rounded-br-[15rem] sm:rounded-br-[10rem] rounded-br-0 relative min-h-screen  w-screen md:py-[6.25rem] py-20">
          ...
          <div className="grid gap-[1.875rem] md:grid-cols-2 grid-cols-1 items-center">
            ...
            <div>
              <div className="featuredCap relative w-full mt-10 md:mt-0">
                ...
                <h2>
                  <span className="font-bold text-[2.3rem] sm:text-[3rem] md:text-[3.5rem] lg:text-[4rem] xl:text-[5rem] font-Poppins text-white">
                    097UNI
                  </span>
                  <span className="font-normal text-[2.3rem] sm:text-[3rem] md:text-[3.5rem] lg:text-[4rem] xl:text-[5rem] indent-[50%] m-5 text-accent font-Poppins">
                    x
                  </span>
                  <span className="font-normal text-[2.3rem] sm:text-[3rem] md:text-[3.5rem] lg:text-[4rem] xl:text-[5rem] text-accent font-Poppins">
                    GBU
                  </span>
                </h2>
                ...
                <p className="text-[1rem] sm:text-[1.125rem] md:text-[1.25rem] lg:text-[1.25rem] xl:text-[1.375rem] text-desc md:leading-9 sm:leading-7 leading-6 w-full md:w-full lg:w-full xl:w-3/4 mt-6">
                  Associazione Studentesca dell'Università degli Studi della
                  Basilicata
                </p>
